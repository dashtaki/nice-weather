...
describe('HourDetailComponent', () => {
    ...
    it('should show all hourly forecast list', () => {
        const allHours: DebugElement[] = fixture.debugElement.queryAll(
            By.css('.row')
        );
    ...
    it('should call TimeComponent with unit time', () => {
        const TimeComponent: DebugElement = fixture.debugElement.query(
            By.css('app-time')
        );
    ...
    it('should call TemperatureComponent with temperature', () => {
        const TemperatureComponent: DebugElement = fixture.debugElement.query(
            By.css('app-temperature')
        );
    ...
    it('should call IconComponent with icon data', () => {
        const IconComponent: DebugElement = fixture.debugElement.query(
            By.css('app-icon')
        );
    ...
    it('should call HumidityComponent with humidity', () => {
        const HumidityComponent: DebugElement = fixture.debugElement.query(
            By.css('app-humidity')
        );
    ...
    it('should call FeelsLikeComponent with feels like', () => {
        const FeelsLikeComponent: DebugElement = fixture.debugElement.query(
            By.css('app-feels-like')
        );
    ...
    it('should call WindComponent with wind data', () => {
        const WindComponent: DebugElement = fixture.debugElement.query(
            By.css('app-wind')
        );
    ...
    it('should call UvIndexComponent with wind data', () => {
        const UvIndexComponent: DebugElement = fixture.debugElement.query(
            By.css('app-uv-index')
        );
